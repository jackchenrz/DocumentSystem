...
public class SignActivity$$ViewInjector {
  public static void inject(Finder finder, final com.publicstech.documentsystem.activity.doc.SignActivity target, Object source) {
    View view;
    view = finder.findRequiredView(source, 2131361837, "field 'llSel3'");
    ...
    view = finder.findRequiredView(source, 2131361836, "field 'iv_line_dep'");
    ...
    view = finder.findRequiredView(source, 2131361834, "field 'etDep'");
    target.etDep = (android.widget.EditText) view;
    view = finder.findRequiredView(source, 2131361840, "field 'ivMode' and method 'onSelMode'");
    ...
    view = finder.findRequiredView(source, 2131361841, "field 'iv_line_mode'");
    ...
    view = finder.findRequiredView(source, 2131361839, "field 'etMode'");
    target.etMode = (android.widget.EditText) view;
    view = finder.findRequiredView(source, 2131361835, "field 'ivDep' and method 'onSelLookMan'");
    ...
    view = finder.findRequiredView(source, 2131361838, "field 'tvSel3'");
